...
struct DetailPersonPopularView: View {
...
struct PersonDetailImage: View {
    ...
    init(model: KnownForViewModel) {
        self.person = model
        self.imageLoaderVM.loadImage(whit: self.person.posterPathUrl)
    }
...
struct DetailPersonPopularView_Previews: PreviewProvider {
    static var previews: some View {
        DetailPersonPopularView(dataModel: [KnownForViewModel(
                                                id: 0,
